...
const NAV = [
  { href: "/app/buyer",         icon: Home,        label: "Home"   },
  { href: "/app/buyer/orders",  icon: ShoppingBag, label: "Orders" },
  { href: "/app/buyer/wallet",  icon: Wallet,      label: "Wallet" },
  { href: "/app/buyer/profile", icon: User,        label: "Profile"},
];
